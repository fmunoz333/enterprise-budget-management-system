...
|---------|--------|-----------|
| Mobile Telephony | $386.4M | 53.76% |
| Internet and Data | $175.9M | 24.48% |
| Transmission Infrastructure | $104.9M | 14.59% |
| Information Technology | $36.4M | 5.07% |
| Fixed Telephony | $15.2M | 2.10% |

### Top 5 Projects by Budget

| Project ID | Project Name | Budget | % |
|-----------|--------------|--------|---|
| MV.16.001 | Mobile Network Expansion | $288.57M | 40.15% |
| NT.18.003 | Fixed Services Expansion | $90.83M | 12.64% |
| NT.22.001 | GPON Expansion | $76.08M | 10.58% |
| MV.25.002 | Mobile Network Modernization | $40.96M | 5.70% |
| TX.14.001 | Radio Network | $36.74M | 5.11% |
